...
initial_english_html = """
    ...
    <p><a href="gavrielawedding.com/invitation/{1}">gavrielawedding.com/invitation/{1}</a></p>
    <p>&nbsp;</p>
...
initial_hebrew_html = """
    ...
    <a href="gavrielawedding.com/invitation/{}">gavrielawedding.com/invitation/{}</a></p>
    <p style="direction: rtl; text-align: right;">&nbsp;</p>
