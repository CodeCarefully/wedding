...
urlpatterns = patterns(
    ...
    url(r'^(?P<invite_id>\d+)/(?P<guest_id>\d+)/diet/(?P<diet>\w+)/?$', views.invitation_input_diet, name="rsvp"),
    url(r'^(?P<invite_id>\d+)/family_number/(?P<family_number>\w+)/?$', views.invitation_input_family, name="rsvp"),
